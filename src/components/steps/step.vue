        ...
        <div :class="[prefixCls + '-main']">
            ...
            <slot>
                ...
                <div v-show="stepType==='true'">
                    ...
                    <Tooltip  v-if="content" :disabled="!isHide" max-width="200" placement="top" :transfer="true" style="display:block" :content='content'>
                        <div v-on:click="eventTri" :class="[prefixCls + '-content', `${isHide ? 'text-ellipsis' : '' }`]">{{ content }}</div>
                    </Tooltip>
                </div>
                <!--不使用新版-->
